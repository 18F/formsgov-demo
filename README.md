# FaaS (Forms as a Service)  [![CircleCI](https://circleci.com/gh/18f/formservice.svg?style=svg)](https://app.circleci.com/pipelines/github/18F/formservice?branch=CI_Pipeline)
...
This is FaaS application intended to be part of a microservice architecture.REACT is used for UI SPA.

This application was generated using JHipster 6.10.3 .
...
If you're not sure what OAuth and OpenID Connect (OIDC) are, please see [What the Heck is OAuth?](https://developer.okta.com/blog/2017/06/21/what-the-heck-is-oauth)
...
To build the final jar and optimize the faas application for production, run:
